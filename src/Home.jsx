...
function Home() {
  return (
    <div>
      <section className="relative margin md:px-0 padding2 lg:pt-2 lg:pb-44 2xl:pb-64">
        ...
        <div className="relative z-1">
          ...
          <div className="flex flex-col md:flex-row md:justify-between xl:justify-center md:mx-auto md:w-[400px] mt-12 md:mt-10 w-fit text">
            <Link
              className="bg-brand-blue text padded-btn darker-red xl:mr-[18.29px]"
              to="/create-event"
            >
              Create an Event
            </Link>
      ...
      <section className=" margin xl:mt-0  xl:h-[600px] bg-brand-blue py-32 padding md:justify-between  md:flex md:items-center">
      ...
      <div className="py-16 margin bg-brand-blue">
